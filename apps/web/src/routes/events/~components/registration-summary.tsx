...
export const paymentStatuses: PaymentStatus[] = ["not_required", "pending", "paid", "refunded", "expired"];
...
export function RegistrationSummary({
  ...
  const paymentCounts = Object.fromEntries(
    paymentStatuses.map((status) => [status, registrations.filter((registration) => registration.paymentStatus === status).length]),
...
export function PaymentStatusSelect({
  ...
  return (
    <Select value={value} onValueChange={(value) => onChange(value as PaymentStatus)}>
